...
final class AddFriendController: UIViewController {
    ...
    private let interactor: AddFriendBusinessLogic
    ...
    init(interactor: AddFriendBusinessLogic) {
...
extension AddFriendController: AddFriendDisplayLogic {
