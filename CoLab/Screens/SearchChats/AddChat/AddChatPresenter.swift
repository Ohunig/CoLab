...
final class AddChatPresenter: AddChatPresentationLogic, AddChatTableDataLogic {
    ...
    private struct Constants {
        ...
        static let addedButtonTitle = "Добавлено"
    ...
    weak var controller: AddChatDisplayLogic?
    ...
    func presentAddButtonState(_ response: Model.AddButtonState.Response) {
        ...
        controller?.displayAddButtonState(
            Model.AddButtonState.ViewModel(
                title: title,
                isEnabled: !response.isLoading && !response.isAdded
            )
        )
    }
